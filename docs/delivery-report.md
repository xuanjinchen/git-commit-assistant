...
Version 3 delivery is ready. The following traces bind each accepted requirement to the final self-contained Skill and its immutable evaluator evidence.
...
```json
{
  ...
  "capability_claims": [
    {
      "name": "Implicit staged-change commit assistance",
